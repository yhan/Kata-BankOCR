...
namespace BankOcr
{
    ...
    public class BankOcrShould
    {
        ...
        {
            var bankOcrLine = new BankOCrReader();
            var actualAccount = bankOcrLine.ReadAccounts(File.ReadAllLines($@"reference_asciiarts\123956189.txt"));
        ...
        public void Guess_digit_yields_an_invalid_account()
        {
            ...
            var accountComputations = ocrReader.ReadAccounts(readAllLines).ToArray();
